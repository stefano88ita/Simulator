...
public class MainInClass implements Runnable{ 
	String startConfigurationFile = ""; 
	
	public MainInClass(String sc) {
		this.startConfigurationFile=sc;
	}
	...
	public void run()  {
		...
		//init
				...
				Scanner sc = new Scanner(new File(this.startConfigurationFile));
				sc.useDelimiter("\n");
				while(sc.hasNext()){
	...
	}catch(Exception e){System.out.println("There's an exception");}
	}
}
